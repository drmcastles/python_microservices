...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPayment = channel.unary_unary(
                ...
                request_serializer=payment__service__pb2.GetPaymentRequest.SerializeToString,
                response_deserializer=payment__service__pb2.PaymentResponse.FromString,
                _registered_method=True)
...
def add_PaymentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPayment': grpc.unary_unary_rpc_method_handler(
                    servicer.GetPayment,
                    request_deserializer=payment__service__pb2.GetPaymentRequest.FromString,
                    response_serializer=payment__service__pb2.PaymentResponse.SerializeToString,
            ),
    }
...
class PaymentService(object):
    ...
    def GetPayment(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/payment.PaymentService/GetPayment',
            payment__service__pb2.GetPaymentRequest.SerializeToString,
            payment__service__pb2.PaymentResponse.FromString,
            options,
            channel_credentials,
            insecure,
